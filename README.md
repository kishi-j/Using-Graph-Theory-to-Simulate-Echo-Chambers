# King's Certificate Project: Investigating Echo Chambers and their Formation using Graph Theory
### Two types of processes – 

•	behavioural (how people change opinions)

•	algorithmic (how networks and algorithms change connections)

### Two key measures:

•	Q(t) — Modularity: how strongly the network splits into communities 

•	r(t) — Assortativity: how similar connected users opinions are  


## Experiment 1 – null model

Starts with sbm with random opinions, nothing changes, Q and r recorded

<img width="400" height="400" alt="image" src="https://github.com/user-attachments/assets/ea3c01d0-f2e1-447a-93af-477741c51049" />
...
Starts with sbm with random opinions, uses average calculation to change opinions over time

<img width="400" height="400" alt="image" src="https://github.com/user-attachments/assets/01a63f35-7312-4935-9b65-4e952a60e7ad" />
...
## Experiment 3 – algorithmic rewiring

Starts random ernos redyi and edges rewired based on bounded-confidence (no opinion changes)

<img width="400" height="400" alt="image" src="https://github.com/user-attachments/assets/8f64c224-98f5-4e2e-8b81-8bdf20a7e89f" />
...
## Experiment 4 – algorithmic rewiring and opinion updating 

Starts with random SBM with random opinions and opinions updating and then network rewired every step
   
<img width="400" height="400" alt="image" src="https://github.com/user-attachments/assets/da51190b-b660-44b4-b645-14fb6169a8a9" />
